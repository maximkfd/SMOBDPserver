...
$response = array();
    ...
    $result = mysql_query("INSERT INTO marks(authorID, reward, short_description, full_description, longitude, latitude) VALUES('$max_authorID', '$reward', '$short_description', '$full_description', '$longitude', '$latitude')");
